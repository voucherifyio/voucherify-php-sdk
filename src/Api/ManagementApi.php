...
/**
    ...
    /**
     * Operation managementCopyCampaignTemplate
     *
     * Copy Campaign Template to a Project
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     * @param  string $campaignTemplateId Provide the unique identifier of the campaign template. (required)
     * @param  \OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateRequestBody $managementProjectsTemplatesCampaignsCopyCreateRequestBody Determines the details about the template in the destination project as well as the destination project itself. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['managementCopyCampaignTemplate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody
     */
    public function managementCopyCampaignTemplate($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody = null, string $contentType = self::contentTypes['managementCopyCampaignTemplate'][0])
    {
        list($response) = $this->managementCopyCampaignTemplateWithHttpInfo($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody, $contentType);
        return $response;
    }

    /**
     * Operation managementCopyCampaignTemplateWithHttpInfo
     *
     * Copy Campaign Template to a Project
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function managementCopyCampaignTemplateWithHttpInfo($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody = null, string $contentType = self::contentTypes['managementCopyCampaignTemplate'][0])
    {
        $request = $this->managementCopyCampaignTemplateRequest($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation managementCopyCampaignTemplateAsync
     *
     * Copy Campaign Template to a Project
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function managementCopyCampaignTemplateAsync($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody = null, string $contentType = self::contentTypes['managementCopyCampaignTemplate'][0])
    {
        return $this->managementCopyCampaignTemplateAsyncWithHttpInfo($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation managementCopyCampaignTemplateAsyncWithHttpInfo
     *
     * Copy Campaign Template to a Project
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function managementCopyCampaignTemplateAsyncWithHttpInfo($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody = null, string $contentType = self::contentTypes['managementCopyCampaignTemplate'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateResponseBody';
        $request = $this->managementCopyCampaignTemplateRequest($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody, $contentType);
    ...
    /**
     * Create request for operation 'managementCopyCampaignTemplate'
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     * @param  string $campaignTemplateId Provide the unique identifier of the campaign template. (required)
     * @param  \OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsCopyCreateRequestBody $managementProjectsTemplatesCampaignsCopyCreateRequestBody Determines the details about the template in the destination project as well as the destination project itself. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function managementCopyCampaignTemplateRequest($projectId, $campaignTemplateId, $managementProjectsTemplatesCampaignsCopyCreateRequestBody = null, string $contentType = self::contentTypes['managementCopyCampaignTemplate'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling managementCopyCampaignTemplate'
            );
        }
        ...
        if ($campaignTemplateId === null || (is_array($campaignTemplateId) && count($campaignTemplateId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $campaignTemplateId when calling managementCopyCampaignTemplate'
            );
        }



        $resourcePath = '/management/v1/projects/{projectId}/templates/campaigns/{campaignTemplateId}/copy';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($managementProjectsTemplatesCampaignsCopyCreateRequestBody)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($managementProjectsTemplatesCampaignsCopyCreateRequestBody));
            } else {
                $httpBody = $managementProjectsTemplatesCampaignsCopyCreateRequestBody;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation managementListCampaignTemplates
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['managementListCampaignTemplates'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody
     */
    public function managementListCampaignTemplates($projectId, $limit = null, $startingAfterId = null, $order = null, $includeTotal = null, $filters = null, string $contentType = self::contentTypes['managementListCampaignTemplates'][0])
    {
        list($response) = $this->managementListCampaignTemplatesWithHttpInfo($projectId, $limit, $startingAfterId, $order, $includeTotal, $filters, $contentType);
        return $response;
    }

    /**
     * Operation managementListCampaignTemplatesWithHttpInfo
     *
     * List Campaign Templates
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function managementListCampaignTemplatesWithHttpInfo($projectId, $limit = null, $startingAfterId = null, $order = null, $includeTotal = null, $filters = null, string $contentType = self::contentTypes['managementListCampaignTemplates'][0])
    {
        $request = $this->managementListCampaignTemplatesRequest($projectId, $limit, $startingAfterId, $order, $includeTotal, $filters, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation managementListCampaignTemplatesAsync
     *
     * List Campaign Templates
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function managementListCampaignTemplatesAsync($projectId, $limit = null, $startingAfterId = null, $order = null, $includeTotal = null, $filters = null, string $contentType = self::contentTypes['managementListCampaignTemplates'][0])
    {
        return $this->managementListCampaignTemplatesAsyncWithHttpInfo($projectId, $limit, $startingAfterId, $order, $includeTotal, $filters, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation managementListCampaignTemplatesAsyncWithHttpInfo
     *
     * List Campaign Templates
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function managementListCampaignTemplatesAsyncWithHttpInfo($projectId, $limit = null, $startingAfterId = null, $order = null, $includeTotal = null, $filters = null, string $contentType = self::contentTypes['managementListCampaignTemplates'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ManagementProjectsTemplatesCampaignsListResponseBody';
        $request = $this->managementListCampaignTemplatesRequest($projectId, $limit, $startingAfterId, $order, $includeTotal, $filters, $contentType);
    ...
    /**
     * Create request for operation 'managementListCampaignTemplates'
     *
     * @param  string $projectId Provide the unique identifier of the project. (required)
     * @param  int $limit Limits the number of objects to be returned. The limit can range between 1 and 100 items. If no limit is set, it returns 10 items. (optional)
     * @param  string $startingAfterId A cursor for pagination. It retrieves the campaign templates created after a template with the given ID. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function managementListCampaignTemplatesRequest($projectId, $limit = null, $startingAfterId = null, $order = null, $includeTotal = null, $filters = null, string $contentType = self::contentTypes['managementListCampaignTemplates'][0])
    {

        // verify the required parameter 'projectId' is set
        if ($projectId === null || (is_array($projectId) && count($projectId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $projectId when calling managementListCampaignTemplates'
            );
        }

        if ($limit !== null && $limit > 100) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagementApi.managementListCampaignTemplates, must be smaller than or equal to 100.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ManagementApi.managementListCampaignTemplates, must be bigger than or equal to 1.');
        }
        ...
        $resourcePath = '/management/v1/projects/{projectId}/templates/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
