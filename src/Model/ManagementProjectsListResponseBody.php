...
/**
 * ManagementProjectsListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\ManagementProject[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about the projects in a dictionary.
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of project objects.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ManagementProject[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ManagementProject[]|null $data Array of project objects.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of projects.
     *
     * @return self
     */
