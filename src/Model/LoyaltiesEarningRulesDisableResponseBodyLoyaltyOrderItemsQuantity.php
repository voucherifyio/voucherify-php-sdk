...
/**
 * LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity';
    ...
    protected static $openAPITypes = [
        ...
        'object' => 'string',
        'id' => 'string',
        'applicableTo' => '\OpenAPI\Client\Model\LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem[]'
    ];
    ...
    */
     ...
     * Gets applicableTo
     *
     * @return \OpenAPI\Client\Model\LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem[]|null
     */
     ...
     * Sets applicableTo
     *
     * @param \OpenAPI\Client\Model\LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem[]|null $applicableTo Defines products, SKUs, or product collections covered by the earning rule. Can be replaced by `object` and `id` to define only one object.
     *
     * @return self
     */
