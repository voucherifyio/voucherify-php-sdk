...
class ApplicableTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'orderItemUnits' => '\OpenAPI\Client\Model\ApplicableToOrderItemUnitsItem[]',
        'repeat' => 'int',
        'skipInitially' => 'int',
        'target' => 'string'
    ];
    ...
    */
     ...
     * Gets orderItemUnits
     *
     * @return \OpenAPI\Client\Model\ApplicableToOrderItemUnitsItem[]|null
     */
     ...
     * Sets orderItemUnits
     *
     * @param \OpenAPI\Client\Model\ApplicableToOrderItemUnitsItem[]|null $orderItemUnits Lists which units within order lines are covered by the discount. The order line items are listed according to sequence of applied discounts while the `index` corresponds to the order line sent in the `order` object in the request.
     *
     * @return self
     */
