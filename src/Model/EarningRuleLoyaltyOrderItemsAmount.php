...
class EarningRuleLoyaltyOrderItemsAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'object' => 'string',
        'id' => 'string',
        'applicableTo' => '\OpenAPI\Client\Model\EarningRuleLoyaltyOrderItemsAmountApplicableToItem[]'
    ];
    ...
    */
     ...
     * Gets applicableTo
     *
     * @return \OpenAPI\Client\Model\EarningRuleLoyaltyOrderItemsAmountApplicableToItem[]|null
     */
     ...
     * Sets applicableTo
     *
     * @param \OpenAPI\Client\Model\EarningRuleLoyaltyOrderItemsAmountApplicableToItem[]|null $applicableTo Defines products, SKUs, or product collections covered by the earning rule. Can be replaced by `object` and `id` to define only one object.
     *
     * @return self
     */
