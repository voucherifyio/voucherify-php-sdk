...
/**
 * EarningRuleLoyaltyOrderItemsSubtotalAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class EarningRuleLoyaltyOrderItemsSubtotalAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EarningRuleLoyaltyOrderItemsSubtotalAmount';
    ...
    protected static $openAPITypes = [
        ...
        'object' => 'string',
        'id' => 'string',
        'applicableTo' => '\OpenAPI\Client\Model\EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem[]'
    ];
    ...
    */
     ...
     * Gets applicableTo
     *
     * @return \OpenAPI\Client\Model\EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem[]|null
     */
     ...
     * Sets applicableTo
     *
     * @param \OpenAPI\Client\Model\EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem[]|null $applicableTo Defines products, SKUs, or product collections covered by the earning rule. Can be replaced by `object` and `id` to define only one object.
     *
     * @return self
     */
