...
/**
 * ManagementProjectsBrandingListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsBrandingListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsBrandingListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\ManagementProjectsBranding[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about the brand in a dictionary.
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of brand objects.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ManagementProjectsBranding[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ManagementProjectsBranding[]|null $data Array of brand objects. It contains only one object.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of brand objects. It is always `1`.
     *
     * @return self
     */
