...
/**
 * CategoryWithStackingRulesType Class Doc Comment
 *
 * @category Class
 ...
 */
class CategoryWithStackingRulesType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryWithStackingRulesType';
    ...
    */
    ...
    public function setHierarchy($hierarchy)
    {
        ...
        if (!is_null($hierarchy) && ($hierarchy < 0)) {
            throw new \InvalidArgumentException('invalid value for $hierarchy when calling CategoryWithStackingRulesType., must be bigger than or equal to 0.');
        }
