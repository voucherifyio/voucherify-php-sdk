...
class QualificationsOptionFiltersHolderRoleConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets isNot
     *
     * @param string[]|null $isNot Will return records only for the first value in the array.
     *
     * @return self
     */
     ...
     * Sets notIn
     *
     * @param string[]|null $notIn Will return records for the values in the array.
     *
     * @return self
     */
