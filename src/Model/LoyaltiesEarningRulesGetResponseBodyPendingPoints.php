...
/**
 * LoyaltiesEarningRulesGetResponseBodyPendingPoints Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesEarningRulesGetResponseBodyPendingPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesEarningRulesGetResponseBodyPendingPoints';
    ...
    */
    ...
    public function setPeriodValue($periodValue)
    {
        ...
        if (!is_null($periodValue) && ($periodValue > 90)) {
            throw new \InvalidArgumentException('invalid value for $periodValue when calling LoyaltiesEarningRulesGetResponseBodyPendingPoints., must be smaller than or equal to 90.');
        }
        if (!is_null($periodValue) && ($periodValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $periodValue when calling LoyaltiesEarningRulesGetResponseBodyPendingPoints., must be bigger than or equal to 1.');
        }
