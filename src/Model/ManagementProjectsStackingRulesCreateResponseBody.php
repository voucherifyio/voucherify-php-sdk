...
/**
 * ManagementProjectsStackingRulesCreateResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsStackingRulesCreateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsStackingRulesCreateResponseBody';
    ...
    */
    ...
    public function setRedeemablesLimit($redeemablesLimit)
    {
        ...
        if (!is_null($redeemablesLimit) && ($redeemablesLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $redeemablesLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be smaller than or equal to 30.');
        }
        if (!is_null($redeemablesLimit) && ($redeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $redeemablesLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableRedeemablesLimit($applicableRedeemablesLimit)
    {
        ...
        if (!is_null($applicableRedeemablesLimit) && ($applicableRedeemablesLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be smaller than or equal to 30.');
        }
        if (!is_null($applicableRedeemablesLimit) && ($applicableRedeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableRedeemablesPerCategoryLimit($applicableRedeemablesPerCategoryLimit)
    {
        ...
        if (!is_null($applicableRedeemablesPerCategoryLimit) && ($applicableRedeemablesPerCategoryLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be smaller than or equal to 30.');
        }
        if (!is_null($applicableRedeemablesPerCategoryLimit) && ($applicableRedeemablesPerCategoryLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableExclusiveRedeemablesLimit($applicableExclusiveRedeemablesLimit)
    {
        ...
        if (!is_null($applicableExclusiveRedeemablesLimit) && ($applicableExclusiveRedeemablesLimit > 5)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be smaller than or equal to 5.');
        }
        if (!is_null($applicableExclusiveRedeemablesLimit) && ($applicableExclusiveRedeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableExclusiveRedeemablesPerCategoryLimit($applicableExclusiveRedeemablesPerCategoryLimit)
    {
        ...
        if (!is_null($applicableExclusiveRedeemablesPerCategoryLimit) && ($applicableExclusiveRedeemablesPerCategoryLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be smaller than or equal to 30.');
        }
        if (!is_null($applicableExclusiveRedeemablesPerCategoryLimit) && ($applicableExclusiveRedeemablesPerCategoryLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRulesCreateResponseBody., must be bigger than or equal to 1.');
        }
