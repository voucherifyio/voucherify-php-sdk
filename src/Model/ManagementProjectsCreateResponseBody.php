...
/**
 * ManagementProjectsCreateResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsCreateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsCreateResponseBody';
    ...
    protected static $openAPITypes = [
        ...
        'apiUsageNotifications' => '\OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyApiUsageNotifications',
        'webhooksCalloutNotifications' => '\OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyWebhooksCalloutNotifications',
        'clusterId' => 'string',
        'caseSensitiveCodes' => 'bool',
        'apiVersion' => 'string',
        'isSandbox' => 'bool',
        'webhookToken' => 'string',
        'serverSideKey' => '\OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyServerSideKey',
        'clientSideKey' => '\OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyClientSideKey'
    ];
    ...
    protected static $setters = [
        ...
        'serverSideKey' => 'setServerSideKey',
        'clientSideKey' => 'setClientSideKey'
    ];
    ...
    protected static $getters = [
        ...
        'serverSideKey' => 'getServerSideKey',
        'clientSideKey' => 'getClientSideKey'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('isSandbox', $data ?? [], null);
        $this->setIfExists('webhookToken', $data ?? [], null);
        $this->setIfExists('serverSideKey', $data ?? [], null);
        $this->setIfExists('clientSideKey', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the project.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyApiUsageNotifications|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyApiUsageNotifications|null $apiUsageNotifications apiUsageNotifications
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyWebhooksCalloutNotifications|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyWebhooksCalloutNotifications|null $webhooksCalloutNotifications webhooksCalloutNotifications
     *
     * @return self
     */
     ...
     * Sets clusterId
     *
     * @param string|null $clusterId The identifier of the cluster where the project will be created.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $caseSensitiveCodes Determines if the vouchers in the project will be: - case sensitive - if `true`, `C0dE-cfV` is **not** equal to `c0de-cfv`), - case insensitive - if `false`, `C0dE-cfV` is equal to `c0de-cfv`.
     *
     * @return self
     */
    ...
    {
        return $this->container['isSandbox'];
    }

    /**
     * Sets isSandbox
     *
     * @param bool|null $isSandbox Determines if the project is a sandbox project.
     *
     * @return self
     */
    public function setIsSandbox($isSandbox)
    {
        if (is_null($isSandbox)) {
            array_push($this->openAPINullablesSetToNull, 'isSandbox');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('isSandbox', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['isSandbox'] = $isSandbox;
     ...
     * Sets webhookToken
     *
     * @param string|null $webhookToken Webhook token used for authentication.
     *
     * @return self
     */
     ...
     * Gets serverSideKey
     *
     * @return \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyServerSideKey|null
     */
    public function getServerSideKey()
    {
        return $this->container['serverSideKey'];
    }

    /**
     * Sets serverSideKey
     *
     * @param \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyServerSideKey|null $serverSideKey serverSideKey
     *
     * @return self
     */
    public function setServerSideKey($serverSideKey)
    {
        if (is_null($serverSideKey)) {
            array_push($this->openAPINullablesSetToNull, 'serverSideKey');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('serverSideKey', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['serverSideKey'] = $serverSideKey;
     ...
     * Gets clientSideKey
     *
     * @return \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyClientSideKey|null
     */
    public function getClientSideKey()
    {
        return $this->container['clientSideKey'];
    }

    /**
     * Sets clientSideKey
     *
     * @param \OpenAPI\Client\Model\ManagementProjectsCreateResponseBodyClientSideKey|null $clientSideKey clientSideKey
     *
     * @return self
     */
    public function setClientSideKey($clientSideKey)
    {
        if (is_null($clientSideKey)) {
            array_push($this->openAPINullablesSetToNull, 'clientSideKey');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('clientSideKey', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['clientSideKey'] = $clientSideKey;
