...
/**
 * ManagementProjectsStackingRules Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsStackingRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsStackingRules';
    ...
    */
    ...
    public function setRedeemablesLimit($redeemablesLimit)
    {
        ...
        if (!is_null($redeemablesLimit) && ($redeemablesLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $redeemablesLimit when calling ManagementProjectsStackingRules., must be smaller than or equal to 30.');
        }
        if (!is_null($redeemablesLimit) && ($redeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $redeemablesLimit when calling ManagementProjectsStackingRules., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableRedeemablesLimit($applicableRedeemablesLimit)
    {
        ...
        if (!is_null($applicableRedeemablesLimit) && ($applicableRedeemablesLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesLimit when calling ManagementProjectsStackingRules., must be smaller than or equal to 30.');
        }
        if (!is_null($applicableRedeemablesLimit) && ($applicableRedeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesLimit when calling ManagementProjectsStackingRules., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableRedeemablesPerCategoryLimit($applicableRedeemablesPerCategoryLimit)
    {
        ...
        if (!is_null($applicableRedeemablesPerCategoryLimit) && ($applicableRedeemablesPerCategoryLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRules., must be smaller than or equal to 30.');
        }
        if (!is_null($applicableRedeemablesPerCategoryLimit) && ($applicableRedeemablesPerCategoryLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRules., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableExclusiveRedeemablesLimit($applicableExclusiveRedeemablesLimit)
    {
        ...
        if (!is_null($applicableExclusiveRedeemablesLimit) && ($applicableExclusiveRedeemablesLimit > 5)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesLimit when calling ManagementProjectsStackingRules., must be smaller than or equal to 5.');
        }
        if (!is_null($applicableExclusiveRedeemablesLimit) && ($applicableExclusiveRedeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesLimit when calling ManagementProjectsStackingRules., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableExclusiveRedeemablesPerCategoryLimit($applicableExclusiveRedeemablesPerCategoryLimit)
    {
        ...
        if (!is_null($applicableExclusiveRedeemablesPerCategoryLimit) && ($applicableExclusiveRedeemablesPerCategoryLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRules., must be smaller than or equal to 30.');
        }
        if (!is_null($applicableExclusiveRedeemablesPerCategoryLimit) && ($applicableExclusiveRedeemablesPerCategoryLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesPerCategoryLimit when calling ManagementProjectsStackingRules., must be bigger than or equal to 1.');
        }
