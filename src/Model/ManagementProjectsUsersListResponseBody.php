...
/**
 * ManagementProjectsUsersListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsUsersListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsUsersListResponseBody';
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about the users in a dictionary.
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of user objects.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\User[]|null $data Array of user objects.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of users.
     *
     * @return self
     */
