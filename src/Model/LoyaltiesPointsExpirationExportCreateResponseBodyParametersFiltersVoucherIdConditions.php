...
/**
 * LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherIdConditions Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherIdConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesPointsExpirationExportCreateResponseBodyParametersFiltersVoucherIdConditions';
    ...
    */
     ...
     * Sets not_in
     *
     * @param string[]|null $not_in Array of the resource values that should be excluded from the results.
     *
     * @return self
     */
