...
/**
 * LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount';
    ...
    protected static $openAPITypes = [
        ...
        'object' => 'string',
        'id' => 'string',
        'applicableTo' => '\OpenAPI\Client\Model\LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem[]'
    ];
    ...
    */
     ...
     * Gets applicableTo
     *
     * @return \OpenAPI\Client\Model\LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem[]|null
     */
     ...
     * Sets applicableTo
     *
     * @param \OpenAPI\Client\Model\LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem[]|null $applicableTo Defines products, SKUs, or product collections covered by the earning rule. Can be replaced by `object` and `id` to define only one object.
     *
     * @return self
     */
