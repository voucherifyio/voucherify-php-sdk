...
/**
 * ManagementProjectsTemplatesCampaignsListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsTemplatesCampaignsListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsTemplatesCampaignsListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\CampaignTemplate[]',
        'total' => 'int',
        'hasMore' => 'bool',
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about campaign templates.
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the JSON property that contains the array of campaign templates.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\CampaignTemplate[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\CampaignTemplate[]|null $data Dictionary that contains an array of campaign templates.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of templates, regardless of the applied query parameters. Displayed only if the `include_total` query paremeter is set to `true`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $moreStartingAfter Returns an ID that can be used to return another page of results. Use the template ID in the `starting_after_id` query parameter to display another page of the results starting after the template with that ID.
     *
     * @return self
     */
