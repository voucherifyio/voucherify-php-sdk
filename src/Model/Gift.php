...
class Gift implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Total gift card income over the lifetime of the card. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.
     *
     * @return self
     */
     ...
     *
     * @param int|null $subtractedAmount Total amount of subtracted credits over the gift card lifetime.
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance Available funds. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`. `balance` = `amount` - `subtracted_amount` - `redemption.redeemed_amount`.
     *
     * @return self
     */
