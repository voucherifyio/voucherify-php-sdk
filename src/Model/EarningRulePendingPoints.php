...
/**
 * EarningRulePendingPoints Class Doc Comment
 *
 * @category Class
 ...
 */
class EarningRulePendingPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EarningRulePendingPoints';
    ...
    */
    ...
    public function setPeriodValue($periodValue)
    {
        ...
        if (!is_null($periodValue) && ($periodValue > 90)) {
            throw new \InvalidArgumentException('invalid value for $periodValue when calling EarningRulePendingPoints., must be smaller than or equal to 90.');
        }
        if (!is_null($periodValue) && ($periodValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $periodValue when calling EarningRulePendingPoints., must be bigger than or equal to 1.');
        }
