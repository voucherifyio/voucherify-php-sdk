...
/**
 * ManagementProjectsMetadataSchemasCreateRequestBody Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ManagementProjectsMetadataSchemasCreateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsMetadataSchemasCreateRequestBody';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('allowDefinedOnly', $data ?? [], false);
    ...
    */
     ...
     * Sets relatedObject
     *
     * @param string|null $relatedObject The resource type. You can define custom metadata schemas, which have a custom `\"related_object\"` resource type, or you can use standard resource types: `\"campaign\"`, `\"customer\"`, `\"earning_rule\"`, `\"loyalty_tier\"`, `\"order\"`, `\"order_item\"`, `\"product\"`, `\"promotion_tier\"`, `\"publication\"`, `\"redemption\"`, `\"reward\"`, `\"voucher\"`.
     *
     * @return self
     */
     ...
     * Sets properties
     *
     * @param array<string,\OpenAPI\Client\Model\ManagementProjectsMetadataSchemaDefinition>|null $properties Contains metadata definitions. There can be many properties within this object.  Only the properties sent in the request will be created.
     *
     * @return self
     */
