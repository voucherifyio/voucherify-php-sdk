...
class Redemption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'result' => 'string',
        'status' => 'string',
        'session' => '\OpenAPI\Client\Model\RedemptionSession',
        'relatedRedemptions' => '\OpenAPI\Client\Model\RedemptionRelatedRedemptions',
        'failureCode' => 'string',
        ...
        'loyaltyCard' => '\OpenAPI\Client\Model\RedemptionLoyaltyCard',
    ...
    */
     ...
     * Gets session
     *
     * @return \OpenAPI\Client\Model\RedemptionSession|null
     */
     ...
     * Sets session
     *
     * @param \OpenAPI\Client\Model\RedemptionSession|null $session session
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RedemptionRelatedRedemptions|null $relatedRedemptions relatedRedemptions
     *
     * @return self
     */
     ...
     *
     * @param string|null $relatedObjectId Unique related object ID assigned by Voucherify, i.e. v_lfZi4rcEGe0sN9gmnj40bzwK2FH6QUno for a voucher.
     *
     * @return self
     */
     ...
     * Sets loyaltyCard
     *
     * @param \OpenAPI\Client\Model\RedemptionLoyaltyCard|null $loyaltyCard loyaltyCard
     *
     * @return self
     */
