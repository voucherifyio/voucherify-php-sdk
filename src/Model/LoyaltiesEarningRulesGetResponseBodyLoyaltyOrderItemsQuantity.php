...
/**
 * LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantity';
    ...
    protected static $openAPITypes = [
        ...
        'object' => 'string',
        'id' => 'string',
        'applicableTo' => '\OpenAPI\Client\Model\LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem[]'
    ];
    ...
    */
     ...
     * Gets applicableTo
     *
     * @return \OpenAPI\Client\Model\LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem[]|null
     */
     ...
     * Sets applicableTo
     *
     * @param \OpenAPI\Client\Model\LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsQuantityApplicableToItem[]|null $applicableTo Defines products, SKUs, or product collections covered by the earning rule. Can be replaced by `object` and `id` to define only one object.
     *
     * @return self
     */
