...
class SegmentsCreateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets updatedAt
     *
     * @param \DateTime|null $updatedAt Timestamp in ISO 8601 format indicating when the segment was updated.
     *
     * @return self
     */
