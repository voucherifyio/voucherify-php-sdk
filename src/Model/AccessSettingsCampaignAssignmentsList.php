...
class AccessSettingsCampaignAssignmentsList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessSettingsCampaignAssignmentsList';
    ...
    */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of campaign assignments.
     *
     * @return self
     */
