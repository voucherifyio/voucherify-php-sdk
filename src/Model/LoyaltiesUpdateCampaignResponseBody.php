...
/**
 * LoyaltiesUpdateCampaignResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesUpdateCampaignResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesUpdateCampaignResponseBody';
    ...
    */
     ...
     *
     * @param string|null $activityDurationAfterPublishing Defines the amount of time the campaign will be active in ISO 8601 format after publishing. For example, a campaign with a `duration` of `P24D` will be valid for a duration of 24 days.
     *
     * @return self
     */
