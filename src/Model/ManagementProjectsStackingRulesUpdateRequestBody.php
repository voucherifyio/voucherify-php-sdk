...
/**
 * ManagementProjectsStackingRulesUpdateRequestBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsStackingRulesUpdateRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsStackingRulesUpdateRequestBody';
    ...
    */
    ...
    public function setRedeemablesLimit($redeemablesLimit)
    {
        ...
        if (!is_null($redeemablesLimit) && ($redeemablesLimit > 30)) {
            throw new \InvalidArgumentException('invalid value for $redeemablesLimit when calling ManagementProjectsStackingRulesUpdateRequestBody., must be smaller than or equal to 30.');
        }
        if (!is_null($redeemablesLimit) && ($redeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $redeemablesLimit when calling ManagementProjectsStackingRulesUpdateRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setApplicableExclusiveRedeemablesLimit($applicableExclusiveRedeemablesLimit)
    {
        ...
        if (!is_null($applicableExclusiveRedeemablesLimit) && ($applicableExclusiveRedeemablesLimit > 5)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesLimit when calling ManagementProjectsStackingRulesUpdateRequestBody., must be smaller than or equal to 5.');
        }
        if (!is_null($applicableExclusiveRedeemablesLimit) && ($applicableExclusiveRedeemablesLimit < 1)) {
            throw new \InvalidArgumentException('invalid value for $applicableExclusiveRedeemablesLimit when calling ManagementProjectsStackingRulesUpdateRequestBody., must be bigger than or equal to 1.');
        }
