...
/**
 * LoyaltiesEarningRulesUpdateResponseBodyPendingPoints Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesEarningRulesUpdateResponseBodyPendingPoints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesEarningRulesUpdateResponseBodyPendingPoints';
    ...
    */
    ...
    public function setPeriodValue($periodValue)
    {
        ...
        if (!is_null($periodValue) && ($periodValue > 90)) {
            throw new \InvalidArgumentException('invalid value for $periodValue when calling LoyaltiesEarningRulesUpdateResponseBodyPendingPoints., must be smaller than or equal to 90.');
        }
        if (!is_null($periodValue) && ($periodValue < 1)) {
            throw new \InvalidArgumentException('invalid value for $periodValue when calling LoyaltiesEarningRulesUpdateResponseBodyPendingPoints., must be bigger than or equal to 1.');
        }
