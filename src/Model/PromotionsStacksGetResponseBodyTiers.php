...
/**
 * PromotionsStacksGetResponseBodyTiers Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionsStacksGetResponseBodyTiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromotionsStacksGetResponseBodyTiers';
    ...
    */
    ...
    public function setIds($ids)
    {
        ...
        if (!is_null($ids) && (count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling PromotionsStacksGetResponseBodyTiers., number of items must be greater than or equal to 1.');
        }
