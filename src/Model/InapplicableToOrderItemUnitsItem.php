...
/**
 * InapplicableToOrderItemUnitsItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InapplicableToOrderItemUnitsItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InapplicableToOrderItemUnitsItem';
    ...
    */
     ...
     * Sets index
     *
     * @param int|null $index Number assigned to the order line item in accordance with the order sent in the request.
     *
     * @return self
     */
    public function setIndex($index)
    {
        ...
        if (($index < 0)) {
            throw new \InvalidArgumentException('invalid value for $index when calling InapplicableToOrderItemUnitsItem., must be bigger than or equal to 0.');
        }
