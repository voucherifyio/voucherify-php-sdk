...
/**
 * PromotionsStacksCreateRequestBodyTiers Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionsStacksCreateRequestBodyTiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromotionsStacksCreateRequestBodyTiers';
    ...
    */
    ...
    public function setIds($ids)
    {
        ...
        if (!is_null($ids) && (count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling PromotionsStacksCreateRequestBodyTiers., number of items must be greater than or equal to 1.');
        }
