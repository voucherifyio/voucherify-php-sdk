...
/**
 * PromotionsStacksCreateResponseBodyTiers Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionsStacksCreateResponseBodyTiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromotionsStacksCreateResponseBodyTiers';
    ...
    */
    ...
    public function setIds($ids)
    {
        ...
        if (!is_null($ids) && (count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling PromotionsStacksCreateResponseBodyTiers., number of items must be greater than or equal to 1.');
        }
