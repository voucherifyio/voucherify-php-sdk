...
/**
 * ManagementProjectsWebhooksUpdateResponseBody Class Doc Comment
 *
 * @category Class
 * @description Response body schema for **PUT** &#x60;v1/management/v1/projects/{projectId}/webhooks/{webhookId}&#x60;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ManagementProjectsWebhooksUpdateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsWebhooksUpdateResponseBody';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('object', $data ?? [], 'webhook');
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the webhook.
     *
     * @return self
     */
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt Timestamp representing the date and time when the webhook configuration was created. The value for this parameter is shown in the ISO 8601 format.
     *
     * @return self
     */
