...
/**
 * ManagementProjectsBrandingCreateRequestBodyCockpits Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsBrandingCreateRequestBodyCockpits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsBrandingCreateRequestBodyCockpits';
    ...
    {
        $this->setIfExists('campaignsOverviewEnabled', $data ?? [], false);
        $this->setIfExists('loyaltyEnabled', $data ?? [], true);
        $this->setIfExists('giftCardsEnabled', $data ?? [], true);
        $this->setIfExists('couponsEnabled', $data ?? [], true);
        $this->setIfExists('referralsEnabled', $data ?? [], true);
        $this->setIfExists('theme', $data ?? [], 'default');
        $this->setIfExists('useCustomDoubleOptInRedirectUrl', $data ?? [], false);
