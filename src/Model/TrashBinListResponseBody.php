...
/**
 * TrashBinListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class TrashBinListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrashBinListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\TrashBinItem[]',
        'total' => 'int',
        'hasMore' => 'bool',
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about the bin entries in a dictionary.
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of bin entry objects.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\TrashBinItem[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\TrashBinItem[]|null $data Array of bin entry objects.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of bin entries. This is the number of the entries returned in the array, not the number of all matching results or all resources currently moved to the bin.
     *
     * @return self
     */
     ...
     *
     * @param string|null $moreStartingAfter If `has_more` is `true`, it returns an ID that can be used to return another page of results. Use the ID in the `starting_after_id` query parameter to display another page of the results occuring after the field with that ID.
     *
     * @return self
     */
