 ...
 */
class CustomersUpdateResponseBodyAssets implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomersUpdateResponseBodyAssets';
