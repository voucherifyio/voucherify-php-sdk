...
/**
 * ParametersFiltersListCampaignTransactions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ParametersFiltersListCampaignTransactions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParametersFiltersListCampaignTransactions';
    ...
    protected static $openAPITypes = [
        'junction' => 'string',
        'id' => '\OpenAPI\Client\Model\FilterConditionsString',
    ...
    */
     ...
     * Sets id
     *
     * @param \OpenAPI\Client\Model\FilterConditionsString|null $id id
     *
     * @return self
     */
