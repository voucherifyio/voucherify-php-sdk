...
/**
 * ManagementProjectsWebhooksListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsWebhooksListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsWebhooksListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\ManagementProjectsWebhook[]',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about the webhook configurations in a dictionary.
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of webhook objects.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ManagementProjectsWebhook[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ManagementProjectsWebhook[]|null $data Array of webhook objects.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The total number of webhook objects.
     *
     * @return self
     */
