...
/**
 * TemplatesCampaignsUpdateResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class TemplatesCampaignsUpdateResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TemplatesCampaignsUpdateResponseBody';
    ...
    */
     ...
     * Sets updatedAt
     *
     * @param \DateTime|null $updatedAt Timestamp representing the date and time when the campaign template was last updated. The value is shown in the ISO 8601 format.
     *
     * @return self
     */
