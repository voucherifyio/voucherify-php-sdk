...
/**
 * PromotionStackTiers Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionStackTiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromotionStackTiers';
    ...
    */
    ...
    public function setIds($ids)
    {
        ...
        if (!is_null($ids) && (count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling PromotionStackTiers., number of items must be greater than or equal to 1.');
        }
