...
/**
 * ManagementProjectsBrandingUpdateRequestBodyCockpits Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagementProjectsBrandingUpdateRequestBodyCockpits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementProjectsBrandingUpdateRequestBodyCockpits';
    ...
    */
     ...
     *
     * @param bool|null $campaignsOverviewEnabled Indicates if the campaign overview is turned on for customers.
     *
     * @return self
     */
     ...
     * Sets loyaltyEnabled
     *
     * @param bool|null $loyaltyEnabled Indicates if the loyalty campaign overview is turned on for customers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $giftCardsEnabled Indicates if the gift card overview is turned on for customers.
     *
     * @return self
     */
     ...
     * Sets couponsEnabled
     *
     * @param bool|null $couponsEnabled Indicates if the discount coupon overview is turned on for customers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $referralsEnabled Indicates if the referral campaign overview is turned on for customers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $useCustomDoubleOptInRedirectUrl Indicates if the double opt-in option is turned on.
     *
     * @return self
     */
     ...
     *
     * @param string|null $customDoubleOptInRedirectUrl Defines the URL for the double opt-in consent.
     *
     * @return self
     */
