...
/**
 * ReferralsMembersHoldersListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class ReferralsMembersHoldersListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReferralsMembersHoldersListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\RedeemableHolder[]',
        'total' => 'int',
        'hasMore' => 'bool',
    ...
    */
     ...
     * Sets object
     *
     * @param string|null $object The type of the object represented by JSON. This object stores information about redeemables holders
     *
     * @return self
     */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the JSON property that contains the array of holders.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\RedeemableHolder[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\RedeemableHolder[]|null $data A dictionary that contains an array of holders.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Total number of holders assigned to the redeemable.
     *
     * @return self
     */
