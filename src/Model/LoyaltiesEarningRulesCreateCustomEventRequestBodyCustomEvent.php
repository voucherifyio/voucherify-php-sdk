...
/**
 * LoyaltiesEarningRulesCreateCustomEventRequestBodyCustomEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesEarningRulesCreateCustomEventRequestBodyCustomEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesEarningRulesCreateCustomEventRequestBodyCustomEvent';
    ...
    */
     ...
     * Sets schema_id
     *
     * @param string|null $schema_id Contains a unique identifier of a custom event schema. Assigned by the Voucherify API.
     *
     * @return self
     */
