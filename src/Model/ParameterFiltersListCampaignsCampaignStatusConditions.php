 ...
 */
class ParameterFiltersListCampaignsCampaignStatusConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const IN_DONE = 'DONE';
    public const IN_IN_PROGRESS = 'IN_PROGRESS';
    public const IN_FAILED = 'FAILED';
    public const IN_DRAFT = 'DRAFT';
    public const IN_MODIFYING = 'MODIFYING';
    public const NOT_IN_DONE = 'DONE';
    public const NOT_IN_IN_PROGRESS = 'IN_PROGRESS';
    public const NOT_IN_FAILED = 'FAILED';
    public const NOT_IN_DRAFT = 'DRAFT';
    public const NOT_IN_MODIFYING = 'MODIFYING';
    public const IS_DONE = 'DONE';
    public const IS_IN_PROGRESS = 'IN_PROGRESS';
    public const IS_FAILED = 'FAILED';
    public const IS_DRAFT = 'DRAFT';
    public const IS_MODIFYING = 'MODIFYING';
    public const IS_NOT_DONE = 'DONE';
    public const IS_NOT_IN_PROGRESS = 'IN_PROGRESS';
    public const IS_NOT_FAILED = 'FAILED';
    public const IS_NOT_DRAFT = 'DRAFT';
    public const IS_NOT_MODIFYING = 'MODIFYING';
    ...
    public function getNotInAllowableValues()
    {
        return [
            self::NOT_IN_DONE,
            self::NOT_IN_IN_PROGRESS,
            self::NOT_IN_FAILED,
            self::NOT_IN_DRAFT,
            self::NOT_IN_MODIFYING,
        ];
    }
    ...
    public function getIsNotAllowableValues()
    {
        return [
            self::IS_NOT_DONE,
            self::IS_NOT_IN_PROGRESS,
            self::IS_NOT_FAILED,
            self::IS_NOT_DRAFT,
            self::IS_NOT_MODIFYING,
        ];
    }
