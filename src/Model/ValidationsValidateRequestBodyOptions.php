...
/**
 * ValidationsValidateRequestBodyOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class ValidationsValidateRequestBodyOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ValidationsValidateRequestBodyOptions';
    ...
    */
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 100)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ValidationsValidateRequestBodyOptions., must be smaller than or equal to 100.');
        }
        if (!is_null($language) && (!preg_match("/^[a-zA-Z]{2,3}(-[a-zA-Z]{2,4})?$/", $language))) {
            throw new \InvalidArgumentException("invalid value for \$language when calling ValidationsValidateRequestBodyOptions., must conform to the pattern /^[a-zA-Z]{2,3}(-[a-zA-Z]{2,4})?$/.");
        }
