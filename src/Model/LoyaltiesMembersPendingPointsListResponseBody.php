...
/**
 * LoyaltiesMembersPendingPointsListResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class LoyaltiesMembersPendingPointsListResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoyaltiesMembersPendingPointsListResponseBody';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'dataRef' => 'string',
        'data' => '\OpenAPI\Client\Model\LoyaltyPendingPoints[]',
        'hasMore' => 'bool',
    ...
    */
     ...
     * Sets dataRef
     *
     * @param string|null $dataRef Identifies the name of the attribute that contains the array of pending point objects.
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\LoyaltyPendingPoints[]|null $data A dictionary that contains an array of pending point entries. Each entry in the array is a separate pending point object.
     *
     * @return self
     */
     ...
     *
     * @param string|null $moreStartingAfter Returns an ID that can be used to return another page of results. Use the pending point entry ID in the `starting_after_id` query parameter to display another page of the results starting after the entry with that ID.
     *
     * @return self
     */
