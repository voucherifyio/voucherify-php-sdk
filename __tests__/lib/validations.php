...
use OpenAPI\Client\Model\OrderItemProduct;
use OpenAPI\Client\Model\ValidationsValidateRequestBodyRedeemablesItem;
...
function createValidationsRequestBodyRedeemable($voucherId): ValidationsValidateRequestBodyRedeemablesItem
{
    $redeemable = new ValidationsValidateRequestBodyRedeemablesItem();
