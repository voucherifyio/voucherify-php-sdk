...
class ValidationRulesTest extends TestCase {
    ...
    public function testCreateValidationRule() {
        ...
        [$filteredSnapshot, $filteredResponse] = validatePayloads($snapshot, $createdValRule, $keysToRemove);

        $this->assertEquals($filteredSnapshot, $filteredResponse, 'Error during test with creating validation rule');
    }
}
?>