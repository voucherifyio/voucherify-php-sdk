...
class PublicationsTest extends TestCase {
    ...
    public function testCreatePublications() {
        ...
        [$filteredSnapshot, $filteredResponse] = validatePayloads($snapshot, $createdPublication, $keysToRemove);

        $this->assertEquals($filteredSnapshot, $filteredResponse, 'Error during test with creating publication');
    }
}
