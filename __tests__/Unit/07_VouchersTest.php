...
class VouchersTest extends TestCase
{
    ...
    public function testGetPreviouslyCreatedVoucher()
    {
        ...
        $this->assertTrue(validateDeepMatch($filteredSnapshot, $voucher), 'Error during test with getting previously created voucher');
    }
    ...
    public function testDisableVoucher()
    {
        ...
        $this->assertTrue(validateDeepMatch($filteredSnapshot, $disabledVoucher), 'Error during test with disabling voucher');
    }
    ...
    public function testEnableVoucher()
    {
        ...
        $this->assertTrue(validateDeepMatch($filteredSnapshot, $enabledVoucher), 'Error during test with enabling voucher');
    }
    ...
    public function testUpdateLoyaltyCardBalance()
    {
        ...
        $this->assertTrue(validateDeepMatch($filteredSnapshot, $updatedLoyaltyCard), 'Error during test with updating loyalty card balance');
    }
}
