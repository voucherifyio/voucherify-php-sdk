...
$productId = 'productId_example'; // string | A Voucherify [product](/api-reference/products/get-product) ID or product source ID.
...
$productId = 'productId_example'; // string | A unique Voucherify [product](/api-reference/products/get-product) ID or product source ID.
$skuId = 'skuId_example'; // string | A Voucherify [SKU ID](/api-reference/products/get-sku) or SKU source ID.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **productsUpdateInBulkRequestBody** | [**\OpenAPI\Client\Model\ProductsUpdateInBulkRequestBody[]**](../Model/ProductsUpdateInBulkRequestBody.md)| List the product fields to be updated in each product object. | [optional] |
