...
$qualificationsCheckEligibilityRequestBody = {"scenario":"ALL","options":{"limit":10,"expand":["redeemable"],"sorting_rule":"DEFAULT"}}; // \OpenAPI\Client\Model\QualificationsCheckEligibilityRequestBody | Define order and customer context.
