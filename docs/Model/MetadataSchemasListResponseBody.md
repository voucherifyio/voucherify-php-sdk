...
**schemas** | [**\OpenAPI\Client\Model\MetadataSchema[]**](MetadataSchema.md) | Array of metadata schema objects. The metadata schemas are listed by related object properties. | [optional]
